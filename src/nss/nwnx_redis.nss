	...
	int incrby_increment = 0)
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", key);
	if (get_type != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", get_type);
	if (get_offset != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(get_offset));
	if (set_type != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", set_type);
	if (set_offset != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(set_offset));
	if (set_value != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(set_value));
	if (incrby_type != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", incrby_type);
	if (incrby_offset != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(incrby_offset));
	if (incrby_increment != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(incrby_increment));
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string skipme_yes_no = "")
{
	...
	if (ip_port != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", ip_port);
	if (id_client_id != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(id_client_id));
	if (addr_ip_port != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", addr_ip_port);
	if (skipme_yes_no != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", skipme_yes_no);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string unblock_type = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", client_id);
	if (unblock_type != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", unblock_type);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string options = "")
{
	...
	if (options != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", options);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string reset_type = "")
{
	...
	if (reset_type != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", reset_type);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string async = "")
{
	...
	if (async != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", async);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string storedist_key = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", unit);
	if (withcoord != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", withcoord);
	if (withdist != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", withdist);
	if (withhash != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", withhash);
	if (count_count != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(count_count));
	if (order != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", order);
	if (store_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", store_key);
	if (storedist_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", storedist_key);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string section = "")
{
	...
	if (section != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", section);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	int samples_count = 0)
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", key);
	if (samples_count != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(samples_count));
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string keys_key = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(timeout));
	if (copy != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", copy);
	if (replace != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", replace);
	if (auth_password != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", auth_password);
	if (keys_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", keys_key);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string arguments = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", subcommand);
	if (arguments != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", arguments);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string argument = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", subcommand);
	if (argument != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", argument);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	int freq_frequency = 0)
{
	...
	if (replace != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", replace);
	if (absttl != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", absttl);
	if (idletime_seconds != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(idletime_seconds));
	if (freq_frequency != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(freq_frequency));
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string condition = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", value);
	if (condition != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", condition);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string save_mode = "")
{
	...
	if (save_mode != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", save_mode);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string store_destination = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", key);
	if (by_pattern != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", by_pattern);
	if (limit_offset != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(limit_offset));
	if (limit_count != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(limit_count));
	if (get_pattern != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", get_pattern);
	if (order != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", order);
	if (sorting != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", sorting);
	if (store_destination != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", store_destination);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string member = "")
{
	...
	if (condition != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", condition);
	if (change != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", change);
	if (increment != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", increment);
	...
	string aggregate_aggregate = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", key);
	if (weights_weight != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(weights_weight));
	if (aggregate_aggregate != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", aggregate_aggregate);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string withscores = "")
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(stop));
	if (withscores != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", withscores);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string type_type = "")
{
	...
	if (match_pattern != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", match_pattern);
	if (count_count != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(count_count));
	if (type_type != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", type_type);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string help = "")
{
	...
	if (consumers_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", consumers_key);
	if (consumers_groupname != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", consumers_groupname);
	if (groups_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", groups_key);
	if (stream_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", stream_key);
	if (help != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", help);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	int count = 0)
{
	...
	if (approx != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", approx);
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(count));
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string ID = "")
{
	...
	if (block_milliseconds != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(block_milliseconds));
	...
	string delconsumer_consumername = "")
{
	...
	if (create_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", create_key);
	if (create_groupname != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", create_groupname);
	if (create_id_or__ != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", create_id_or__);
	if (setid_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", setid_key);
	if (setid_groupname != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", setid_groupname);
	if (setid_id_or__ != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", setid_id_or__);
	if (destroy_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", destroy_key);
	if (destroy_groupname != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", destroy_groupname);
	if (delconsumer_key != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", delconsumer_key);
	if (delconsumer_groupname != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", delconsumer_groupname);
	if (delconsumer_consumername != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", delconsumer_consumername);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
	...
	string ID = "")
{
	...
	if (block_milliseconds != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(block_milliseconds));
	if (noack != "")
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", noack);
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", streams);
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", key);
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", ID);
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	...
	int retrycount_count = 0)
{
	...
	NWNX_PushArgumentString("NWNX_Redis", "Deferred", ID);
	if (idle_ms != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(idle_ms));
	if (time_ms_unix_time != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(time_ms_unix_time));
	if (retrycount_count != 0)
		NWNX_PushArgumentString("NWNX_Redis", "Deferred", IntToString(retrycount_count));
	NWNX_CallFunction("NWNX_Redis", "Deferred");
	return NWNX_GetReturnValueInt("NWNX_Redis", "Deferred");
}
