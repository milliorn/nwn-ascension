...
void main()
{
    // "play" music for next 5.5 seconds...
    ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_BARD_SONG), OBJECT_SELF, 5.5);
             ...
             && !GetIsObjectValid(GetNearestSeenEnemy()))
    {
        ...
        {
            if (GetSpawnInCondition(NW_FLAG_AMBIENT_ANIMATIONS) || GetSpawnInCondition(NW_FLAG_AMBIENT_ANIMATIONS_AVIAN) || GetIsEncounterCreature())
            {
