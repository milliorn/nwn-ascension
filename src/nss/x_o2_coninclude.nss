...
int NUMBER_LOW_ONE = 100;
int NUMBER_MED_ONE = 60;
int NUMBER_HIGH_ONE = 40;
int NUMBER_BOSS_ONE = 100;
int NUMBER_LOW_TWO = 0;
int NUMBER_MED_TWO = 30;
int NUMBER_HIGH_TWO = 40;
int NUMBER_BOSS_TWO = 0;
int NUMBER_LOW_THREE = 0;
int NUMBER_MED_THREE = 10;
int NUMBER_HIGH_THREE = 20;
int NUMBER_BOSS_THREE = 0;
...
float LOW_MOD_GOLD = 1.0;
float MEDIUM_MOD_GOLD = 2.0;
float HIGH_MOD_GOLD = 3.0;
// * FREQUENCY OF ITEM TYPE APPEARING BY TREASURE TYPE
int LOW_PROB_BOOK = 1;
int MEDIUM_PROB_BOOK = 1;
int HIGH_PROB_BOOK = 1;
int LOW_PROB_ANIMAL = 0;
int MEDIUM_PROB_ANIMAL = 0;
int HIGH_PROB_ANIMAL = 0;
int LOW_PROB_JUNK = 2;
int MEDIUM_PROB_JUNK = 1;
int HIGH_PROB_JUNK = 1;
int LOW_PROB_GOLD = 43;
int MEDIUM_PROB_GOLD = 38;
int HIGH_PROB_GOLD = 15;
int LOW_PROB_GEM = 9;
int MEDIUM_PROB_GEM = 15;
int HIGH_PROB_GEM = 15;
int LOW_PROB_JEWEL = 4;
int MEDIUM_PROB_JEWEL = 6;
int HIGH_PROB_JEWEL = 15;
int LOW_PROB_ARCANE = 3;
int MEDIUM_PROB_ARCANE = 3;
int HIGH_PROB_ARCANE = 3;
int LOW_PROB_DIVINE = 3;
int MEDIUM_PROB_DIVINE = 3;
int HIGH_PROB_DIVINE = 3;
int LOW_PROB_AMMO = 10;
int MEDIUM_PROB_AMMO = 5;
int HIGH_PROB_AMMO = 3;
int LOW_PROB_KIT = 5;
int MEDIUM_PROB_KIT = 5;
int HIGH_PROB_KIT = 5;
int LOW_PROB_POTION = 17;
int MEDIUM_PROB_POTION = 20;
int HIGH_PROB_POTION = 9;
int LOW_PROB_TABLE2 = 3;
int MEDIUM_PROB_TABLE2 = 3;
int HIGH_PROB_TABLE2 = 30;
...
/*
    Returns the adjusted hit dice of the target creature. This function is
    used to reduce loot farming by high level characters in low risk areas.
    Maximum level can be defined by container or area. The local integer
    GT_MAX_LEVEL is used to define the maximum level.
*/
int GetAdjHitDice(object oTarget)
{
    int iMaxLevel, iHitDice, iAdjHitDice;

    /* does container have a maximum level set? */
    iMaxLevel = GetLocalInt(OBJECT_SELF, "GT_MAX_LEVEL");

    /* if not, does area? */
    if (iMaxLevel == 0)
    {
        iMaxLevel = GetLocalInt(GetArea(OBJECT_SELF), "GT_MAX_LEVEL");
        dbSpeak("Area max level = " + IntToString(iMaxLevel));
    }
    else
    {
        dbSpeak("Item max level = " + IntToString(iMaxLevel));
    }

    iHitDice = GetHitDice(oTarget);

    /* if max level is set and hit dice exceeds it then cap it */
    if ((iMaxLevel > 0) && (iHitDice > iMaxLevel))
    {
        iAdjHitDice = iMaxLevel;
        dbSpeak("iAdjHitDice = " + IntToString(iAdjHitDice));
    }
    else
    {
        iAdjHitDice = iHitDice;
        dbSpeak("iHitDice = " + IntToString(iHitDice));
    }
...
/*
    Get the refill delay for the container. The generate treasure functions
    (X_O2_*) use this function to refill a container after a delay. The delay
    is in seconds and can be defined by container, area or a default. The local
    float GT_REFILL_DELAY is used to define the refill delay.
*/
float GetRefillDelay()
{
    float fRefillDelay;

    /* does container have a refill delay set? */
    fRefillDelay = GetLocalFloat(OBJECT_SELF, "GT_REFILL_DELAY");

    /* if not, does area? */
    if (fRefillDelay == 0.0)
    {
        fRefillDelay = GetLocalFloat(GetArea(OBJECT_SELF), "GT_REFILL_DELAY");

        if (fRefillDelay == 0.0)
        {
            fRefillDelay = 1000.0; /* no refill delay found, use default */
            dbSpeak("Default refill delay = " + FloatToString(fRefillDelay));
        }
        else
        {
            dbSpeak("Area refill delay = " + FloatToString(fRefillDelay));
        }
    }
    else
    {
        dbSpeak("Item refill delay = " + FloatToString(fRefillDelay));
    }
...
int GetNumberOfItems(int nTreasureType)
{
    ...
    else if (nRandom <= nProbTwoItems + nProbThreeItems)
    {
        nItems = 2;
    }
    else
...
void CreateAnimalPart(object oTarget)
{
    ...
    {
    case 1:
        sRes = "NW_IT_MSMLMISC20";
        break;
    case 2:
        sRes = "NW_IT_MMIDMISC05";
        break;
    case 3:
        sRes = "NW_IT_MMIDMISC06";
        break;
    }
    dbSpeak("animal");
    dbCreateItemOnObject(sRes, oTarget);
...
void CreateJunk(object oTarget)
{
    ...
    {
    case 1:
        sRes = "NW_IT_MPOTION021";
        break; //ale
    case 2:
        sRes = "NW_IT_MPOTION021";
        break; // ale
    case 3:
        sRes = "NW_IT_MPOTION023";
        break; // wine
    case 4:
        sRes = "NW_IT_MPOTION021";
        break; // ale
    case 5:
        sRes = "NW_IT_MPOTION022";
        break; // spirits
    case 6:
        sRes = "NW_IT_TORCH001";
        break; //torch
...
{
    int nHD = GetAdjHitDice(oAdventurer) + nModifier;
    int nAmount = 0;
...
void CreateJewel(object oTarget, object oAdventurer, int nTreasureType, int nModifier = 0)
{
    ...
    if (GetRange(1, nHD)) // 15 gp avg; 75 gp max
    {
        ...
        {
        case 1:
            sJewel = "nw_it_mring021";
            break;
        case 2:
            sJewel = "nw_it_mneck020";
            break;
        }
    }
    else if (GetRange(2, nHD)) // 30 GP Avg; 150 gp Max
    {
        ...
        case 3:
            ...
            break;
        case 4:
            sJewel = "nw_it_mring022";
            break;
        case 5:
        case 6:
            sJewel = "nw_it_mneck023";
            break;
        }
    }
    else if (GetRange(3, nHD)) // 75GP Avg; 500 gp max
...
void CreateDivineScroll(object oTarget, object oAdventurer, int nModifier = 0)
{
    ...
    if (GetRange(1, nHD))
    {
        ...
        {
        case 1:
            sScroll = "nw_it_spdvscr201";
            break;
        case 2:
            sScroll = "nw_it_spdvscr202";
            break;
        case 3:
            sScroll = "nw_it_spdvscr203";
            break;
        case 4:
            sScroll = "nw_it_spdvscr204";
            break;
        }
    }
    else if (GetRange(2, nHD))
    {
        ...
        case 4:
            ...
            break;
        case 5:
            sScroll = "nw_it_spdvscr301";
            break;
        case 6:
            sScroll = "nw_it_spdvscr302";
            break;
        case 7:
            sScroll = "nw_it_spdvscr401";
            break;
        case 8:
            sScroll = "nw_it_spdvscr402";
            break;
        }
    }
    else if (GetRange(3, nHD))
    ...
    else
    {
        ...
        case 5:
            ...
            break;
        case 6:
            sScroll = "nw_it_spdvscr701";
            break;
        case 7:
            sScroll = "nw_it_spdvscr702";
            break;
        }
    }
...
void CreateKit(object oTarget, object oAdventurer, int nModifier = 0)
{
    ...
    {
    case 1:
        CreateTrapKit(oTarget, oAdventurer, nModifier);
        break;
    case 2:
    case 3:
    case 4:
    case 5:
        CreateHealingKit(oTarget, oAdventurer, nModifier);
        break;
    case 6:
    case 7:
    case 8:
        CreateLockPick(oTarget, oAdventurer, nModifier);
        break;
    }
}
...
void CreatePotion(object oTarget, object oAdventurer, int nModifier = 0)
{
    ...
    if (GetRange(1, nHD))
    {
        ...
        case 6:
        case 7:
            sPotion = "nw_it_mpotion020";
            break;
        case 8:
            sPotion = "nw_it_mpotion002";
            break;
        case 9:
            sPotion = "nw_it_mpotion009";
            break;
        case 10:
            sPotion = "nw_it_mpotion005";
            break;
        }
    }
    else if (GetRange(2, nHD))
    {
        ...
        case 16:
            ...
            break;
        case 17:
            sPotion = "nw_it_mpotion007";
            break;
        case 18:
            sPotion = "nw_it_mpotion008";
            break;
        case 19:
            sPotion = "nw_it_mpotion010";
            break;
        case 20:
            sPotion = "nw_it_mpotion011";
            break;
        case 21:
            sPotion = "nw_it_mpotion013";
            break;
        case 22:
            sPotion = "nw_it_mpotion014";
            break;
        case 23:
            sPotion = "nw_it_mpotion015";
            break;
        case 24:
            sPotion = "nw_it_mpotion016";
            break;
        case 25:
            sPotion = "nw_it_mpotion017";
            break;
        case 26:
            sPotion = "nw_it_mpotion018";
            break;
        case 27:
            sPotion = "nw_it_mpotion019";
            break;
        case 28:
            sPotion = "nw_it_mpotion004";
            break;
        case 29:
            sPotion = "nw_it_mpotion006";
            break;
        }
    }
    else if (GetRange(3, nHD))
...
void CreateGenericMiscItem(object oTarget, object oAdventurer, int nModifier = 0)
{
    ...
    if (GetRange(1, nHD)) // * 200
    {
        ...
        {
        case 1:
            sItem = "nw_it_mglove004";
            break;
        case 2:
            sItem = "nw_it_mglove004";
            break;
        case 3:
            sItem = "nw_it_mglove005";
            break;
        case 4:
            sItem = "nw_it_mglove006";
            break;
        case 5:
            sItem = "nw_it_mglove007";
            break;
        case 6:
            sItem = "nw_it_mglove008";
            break;
        case 7:
            sItem = "nw_it_mglove009";
            break;
        case 8:
            sItem = "nw_mcloth006";
            break;
        case 9:
            sItem = "nw_it_mglove012";
            break;
        }
    }
    else if (GetRange(2, nHD)) // * 800
    {
        ...
        case 1:
            ...
            break;
        case 2:
            sItem = "nw_it_mring009";
            break;
        case 3:
            sItem = "nw_it_mring009";
            break;
        case 4:
            sItem = "nw_it_mring010";
            break;
        case 5:
            sItem = "nw_it_mring011";
            break;
        case 6:
            sItem = "nw_it_mboots010";
            break;
        case 7:
            sItem = "nw_it_mneck024";
            break;
        case 8:
            sItem = "nw_mcloth007";
            break;
        case 9:
            sItem = "nw_it_mring024";
            break;
        case 10:
            sItem = "nw_it_mring012";
            break;
        case 11:
            sItem = "nw_mcloth008";
            break;
        case 12:
            sItem = "nw_it_mglove010";
            break;
        case 13:
            sItem = "nw_it_mglove011";
            break;
        case 14:
            sItem = "nw_it_mglove013";
            break;
        case 15:
            sItem = "nw_it_mglove014";
            break;
        case 16:
            sItem = "nw_it_mglove015";
            break;
        case 17:
            sItem = "nw_maarcl097";
            break;
        ...
        case 19:
            ...
            break;
        case 20:
            sItem = "nw_it_mneck032";
            break;
        case 21:
            sItem = "nw_mcloth010";
            break;
        case 22:
            sItem = "nw_it_mbracer002";
            break;
        case 23:
            sItem = "nw_it_mneck001";
            break;
        case 24:
            sItem = "nw_maarcl055";
            break;
    ...
    else if (GetRange(3, nHD)) // * 200 - 2500
    {
        ...
        case 24:
            ...
            break;
        case 25:
            sItem = "nw_it_mring001";
            break;
        case 26:
            sItem = "nw_it_mboots001";
            break;
        case 27:
            sItem = "nw_it_mbracer001";
            break;
        case 28:
            sItem = "nw_it_mneck007";
            break;
        case 29:
            sItem = "nw_maarcl096";
            break;
        case 30:
            sItem = "nw_it_mglove003";
            break;
        case 31:
            sItem = "nw_it_contain004";
            break;
        case 32:
            sItem = "nw_it_mneck031";
            break;
        case 33:
            sItem = "nw_it_mring006";
            break;
        case 34:
            sItem = "nw_it_mneck006";
            break;
        case 35:
            sItem = "nw_it_mneck029";
            break;
        case 36:
            sItem = "nw_it_mring013";
            break;
        case 37:
            sItem = "nw_it_mboots011";
            break;
        case 38:
            sItem = "nw_it_mneck025";
            break;
        case 39:
            sItem = "nw_it_mbelt009";
            break;
        case 40:
            sItem = "nw_it_mbelt010";
            break;
        case 41:
            sItem = "nw_it_mbelt011";
            break;
        case 42:
            sItem = "nw_it_mring025";
            break;
        case 43:
            sItem = "nw_it_mring025";
            break;
    ...
    else if (GetRange(4, nHD)) // * 800 - 10000
    {
        ...
        case 19:
            ...
            break;
        case 20:
            sItem = "nw_it_mbracer007";
            break;
        case 21:
            sItem = "nw_it_mbracer007";
            break;
        case 22:
            sItem = "nw_it_mneck012";
            break;
        case 23:
            sItem = "nw_maarcl088";
            break;
        case 24:
            sItem = "nw_it_mboots012";
            break;
        case 25:
            sItem = "nw_it_mneck026";
            break;
        case 26:
            sItem = "nw_it_mboots006";
            break;
        case 27:
            sItem = "nw_it_mbracer003";
            break;
        case 28:
            sItem = "nw_it_mneck008";
            break;
        case 29:
            sItem = "nw_it_mring008";
            break;
        case 30:
            sItem = "nw_maarcl056";
            break;
        case 31:
            ...
            break;
        case 32:
            sItem = "nw_it_mring014";
            break;
        case 33:
            sItem = "nw_it_mneck016";
            break;
        case 34:
            sItem = "nw_it_mboots013";
            break;
        case 35:
            sItem = "nw_it_mneck027";
            break;
        case 36:
            sItem = "nw_it_mbracer008";
            break;
        case 37:
            sItem = "nw_it_mneck013";
            break;
        case 38:
            sItem = "nw_maarcl089";
            break;
        case 39:
            sItem = "nw_it_mbelt012";
            break;
        case 40:
            sItem = "nw_it_mbelt013";
            break;
        case 41:
            sItem = "nw_it_mbelt014";
            break;
        case 42:
            sItem = "nw_it_mring027";
            break;
        case 43:
            sItem = "nw_it_mboots007";
            break;
        case 44:
            sItem = "nw_it_mbracer004";
            break;
        case 45:
            sItem = "nw_it_mneck009";
            break;
        case 46:
            sItem = "nw_it_mring018";
            break;
        case 47:
            sItem = "nw_maarcl093";
            break;
        case 48:
            sItem = "nw_it_mboots002";
            break;
        }
    }
    else if (GetRange(5, nHD)) // * 2500 - 16500
    {
        ...
        case 29:
            ...
            break;
        case 30:
            sItem = "nw_it_mboots014";
            break;
        case 31:
            sItem = "nw_it_mneck028";
            break;
        case 32:
            sItem = "nw_it_mring015";
            break;
        case 33:
            sItem = "nw_it_mbracer009";
            break;
        case 34:
            sItem = "nw_it_mneck014";
            break;
        case 35:
            sItem = "nw_maarcl090";
            break;
        case 36:
            sItem = "nw_it_mring028";
            break;
        case 37:
            sItem = "nw_it_mneck017";
            break;
        case 38:
            sItem = "nw_it_mboots008";
            break;
        case 39:
            sItem = "nw_it_mbracer005";
            break;
        case 40:
            sItem = "nw_it_mneck010";
            break;
        case 41:
            sItem = "nw_it_mmidmisc02";
            break;
        case 42:
            sItem = "nw_it_mring019";
            break;
        }
    }
    else if (GetRange(6, nHD)) // * 8000 - 25000
    {
        ...
        case 21:
            ...
            break;
        case 22:
            sItem = "nw_it_mring016";
            break;
        case 23:
            sItem = "nw_it_mbracer010";
            break;
        case 24:
            sItem = "nw_it_mneck015";
            break;
        case 25:
            sItem = "nw_maarcl091";
            break;
        case 26:
            sItem = "nw_it_mboots009";
            break;
        case 27:
            sItem = "nw_it_mbracer006";
            break;
        case 28:
            sItem = "nw_it_mneck011";
            break;
        case 29:
            sItem = "nw_maarcl095";
            break;
        case 30:
            sItem = "nw_it_mneck018";
            break;
        }
    }
    dbSpeak("Create Misc");
...
void CreateGenericClassItem(object oTarget, object oAdventurer, int nSpecific = 0)
{
    ...
    else if (GetLevelByClass(CLASS_TYPE_WIZARD, oAdventurer) >= 1 || GetLevelByClass(CLASS_TYPE_SORCERER, oAdventurer) >= 1)
    {
    ...
    else if (GetLevelByClass(CLASS_TYPE_CLERIC, oAdventurer) >= 1)
    {
        ...
        {
        case 1:
            sItem = "nw_it_medkit001";
            break;
        case 2:
            sItem = "nw_it_medkit002";
            break;
        case 3:
            sItem = "nw_it_medkit003";
            break;
        case 4:
            sItem = "nw_it_medkit004";
            break;
        }
        dbCreateItemOnObject(sItem, oTarget, 1);
    }
    else if (GetLevelByClass(CLASS_TYPE_MONK, oAdventurer) >= 1)
    {
    ...
    else if (GetLevelByClass(CLASS_TYPE_ROGUE, oAdventurer) >= 1)
    {
        // * give a misc item as if a couple levels higher
        CreateGenericMiscItem(oTarget, oAdventurer, 2);
    }
    else if (GetLevelByClass(CLASS_TYPE_BARD, oAdventurer) >= 1)
    {
        // * give a misc item as if a couple levels higher
        CreateGenericMiscItem(oTarget, oAdventurer, 2);
    }
...
void CreateSpecificMonkWeapon(object oTarget, object oAdventurer, int nModifier = 0)
{
    ...
    else if (GetRange(2, nHD)) // * 2500
    {
        ...
        case 4:
            ...
            break;
        case 5:
            sItem = "NW_IT_MGLOVE016";
            break;
        case 6:
            sItem = "NW_IT_MGLOVE021";
            break;
        case 7:
            sItem = "NW_IT_MGLOVE026";
            break;
        case 8:
            CreateGenericMonkWeapon(oTarget, oAdventurer, JUMP_LEVEL);
            return;
    ...
    else if (GetRange(3, nHD)) // * 800 - 10000
    {
        ...
        case 14:
            sItem = "NW_IT_MGLOVE017";
            break;
        case 15:
            sItem = "NW_IT_MGLOVE022";
            break;
        case 16:
            sItem = "NW_IT_MGLOVE027";
            break;

        case 17:
            sItem = "NW_IT_MGLOVE018";
            break;
        case 18:
            sItem = "NW_IT_MGLOVE023";
            break;
        case 19:
            sItem = "NW_IT_MGLOVE028";
            break;

        case 20:
            sItem = "NW_IT_MGLOVE029";
            break;
        case 21:
            sItem = "NW_IT_MGLOVE030";
            break;
        }
    }
    else if (GetRange(4, nHD)) // * 2500 -16500
    {
        ...
        case 21:
            sItem = "NW_IT_MGLOVE019";
            break;
        case 22:
            sItem = "NW_IT_MGLOVE024";
            break;
        }
    }
    else // * 16000 +
    {
        ...
        case 23:
            sItem = "NW_IT_MGLOVE020";
            break;
        case 24:
            sItem = "NW_IT_MGLOVE025";
            break;
        }
    }
...
{
    string sItem = "";
    int nHD = GetAdjHitDice(oAdventurer);
    ...
    else if (GetRange(3, nHD)) // * 800 - 10000
    {
        ...
        case 5:
            ...
            break;
        case 6:
            sItem = "nw_it_mglove001";
            break;
        case 7:
            sItem = "nw_maarcl100";
            break;
        case 8:
            sItem = "nw_it_mbracer011";
            break;
        case 9:
            sItem = "nw_it_mmidmisc04";
            break;
        case 10:
            sItem = "nw_it_mring003";
            break;
        case 11:
            sItem = "nw_it_mbelt006";
            break;
        case 12:
            sItem = "nw_it_mbelt002";
            break;
        case 13:
            sItem = "nw_it_mmidmisc03";
            break;
        }
    }
    else if (GetRange(4, nHD)) // * 2500 - 16500
    {
        ...
        case 12:
            ...
            break;
        case 13:
            sItem = "nw_it_mring002";
            break;
        case 14:
            sItem = "nw_it_mbelt004";
            break;
        case 15:
            sItem = "nw_it_mring005";
            break;
        case 16:
            sItem = "nw_it_mboots005";
            break;
        case 17:
            sItem = "nw_it_mring007";
            break;
        case 18:
            sItem = "nw_it_mneck003";
            break;
        case 19:
            sItem = "nw_it_mbelt007";
            break;
        }
    }
    else if (GetRange(5, nHD)) // * 8000 - 25000
    {
        ...
        case 10:
            ...
            break;
        case 11:
            sItem = "nw_it_mboots004";
            break;
        case 12:
            sItem = "nw_it_mboots003";
            break;
        case 13:
            sItem = "nw_it_mneck005";
            break;
        case 14:
            sItem = "nw_it_mbelt008";
            break;
        case 15:
            sItem = "nw_it_mring020";
            break;
        }
    }
    else if (GetRange(6, nHD)) // * 16000 and up
    {
        ...
        case 6:
            ...
            break;
        case 7:
            sItem = "nw_it_mbelt001";
            break;
        case 8:
            sItem = "nw_it_mring017";
            break;
        case 9:
            sItem = "nw_mcloth001";
            break;
        case 10:
            sItem = "nw_it_mneck019";
            break;
        case 11:
            sItem = "nw_it_mneck002";
            break;
        case 12:
            sItem = "nw_it_mneck004";
            break;
        case 13:
            sItem = "nw_it_mmidmisc01";
            break;
        case 14:
            sItem = "nw_mcloth002";
            break;
        ...
        case 16:
            ...
            break;
        case 17:
            sItem = "nw_it_mbelt003";
            break;
        // * new items
        case 18:
            sItem = "NW_IT_MBELT020";
            break;
        case 19:
            sItem = "NW_IT_MBELT021";
            break;
        }
    }
    dbCreateItemOnObject(sItem, oTarget, 1);
...
void CreateTable2Item(object oTarget, object oAdventurer, int nSpecific = 0)
{
    ...
    else if (nRandom <= nProbMisc + nProbClass + nProbRodStaffWand + nProbSimple)
    {
        if (nSpecific == 0)
    ...
    else if (nRandom <= nProbMisc + nProbClass + nProbRodStaffWand + nProbSimple + nProbMartial)
    {
    ...
    else if (nRandom <= nProbMisc + nProbClass + nProbRodStaffWand + nProbSimple + nProbMartial + nProbExotic)
    {
        if (nSpecific == 0)
    ...
    else if (nRandom <= nProbMisc + nProbClass + nProbRodStaffWand + nProbSimple + nProbMartial + nProbExotic + nProbLight)
    {
        if (nSpecific == 0)
    ...
    else if (nRandom <= nProbMisc + nProbClass + nProbRodStaffWand + nProbSimple + nProbMartial + nProbExotic + nProbLight + nProbMedium)
    {
        if (nSpecific == 0)
    ...
    else if (nRandom <= nProbMisc + nProbClass + nProbRodStaffWand + nProbSimple + nProbMartial + nProbExotic + nProbLight + nProbMedium + nProbHeavy)
    {
        if (nSpecific == 0)
...
{
    int nClass;
    int nTotal = GetAdjHitDice(oCharacter);
