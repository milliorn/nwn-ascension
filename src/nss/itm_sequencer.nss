...
void main()
{
    ...
    if (nEvent == X2_ITEM_EVENT_ACTIVATE)
    {
        ...
        else
        {
            ...
            for (n = 1; n <= nNumOfSpells; n++)
            {
                ...
                SendMessageToPC(oPC, "Casting spell " + strSpellName + " at postion " + IntToString(n) + " on item");
    ...
    else if (nEvent == X2_ITEM_EVENT_SPELLCAST_AT)
    {
        ...
        FloatingTextStringOnCreature("Storing " + strSpellName + " at postion " + IntToString(nNumOfSpells) + " on item", oPC, FALSE);
