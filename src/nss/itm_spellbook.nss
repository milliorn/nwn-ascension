...
void main()
{
    switch(GetUserDefinedItemEventNumber())
    {
        case X2_ITEM_EVENT_ACTIVATE:
        {
            ...
            // Random chance of between 1 - 20 spells
            int iSpells = d20();
            ...
            while (iCount < iSpells)
            {
                ...
                default: SendMessageToAllDMs("<có  >WARNING! Script 'itm_spellbook' has a problem");
                ModMiscWebhook("WARNING! Script 'itm_spellbook' has a problem"); break;
                }
                ...
                {
                    ModMiscWebhook("WARNING! Script 'itm_spellbook' has a problem.  Invalid Spell = "+sSpell);
                }
